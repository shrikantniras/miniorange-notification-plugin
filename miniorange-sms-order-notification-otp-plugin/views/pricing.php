...
<div class="mo_main_price_table">
    <table class="mo_price-table">
        ...
        echo'                </td>
                ...
                echo '      </td>
                                <td class="mo_price"><div class="mo_charges">'.esc_attr($twilio_gateway_plus_addon).'</div><br><br><br><br>
                                <div class="mo_plan_description">
                ...
                echo '
                                ...
                                <td class="mo_price"><div class="mo_charges">'.esc_attr($enterprise_addon).'</div><br><br>
