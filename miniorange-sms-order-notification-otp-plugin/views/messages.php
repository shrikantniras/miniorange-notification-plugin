					...
					<tr>
						<td>
							...
							<div id="email_message" style="margin-left:1%;">
								...
								<textarea name="otp_success_email" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($otp_success_email)).'</textarea><br/><br/>
								<div style="margin-bottom:1%;"><strong>'.mo_("ERROR OTP MESSAGE").': </strong><br/></div>
								<textarea name="otp_error_email" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($otp_error_email)).'</textarea><br/><br/>
								...
								<textarea name="otp_invalid_email" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($email_invalid_format)).'</textarea><br/><br/>
								<div style="margin-bottom:1%;"><strong>'.mo_("BLOCKED EMAIL MESSAGE").': </strong><br/>
								<span style="color:red">'.mo_("( NOTE: ##email## in the message body will be replaced by the user's email address )").'</span></div>
								<textarea name="otp_blocked_email" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($otp_blocked_email)).'</textarea><br/>
							</div>
						</td>
					</tr>
				</table>
					...
					<tr>
						<td>
							...
							<div id="sms_message" style="margin-left:1%;">
								...
								<textarea name="otp_success_phone" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($otp_success_phone)).'</textarea><br/><br/>
								<div style="margin-bottom:1%;"><strong>'.mo_("ERROR OTP MESSAGE").': </strong></div>
								<textarea name="otp_error_phone" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($otp_error_phone)).'</textarea><br/><br/>
								<div style="margin-bottom:1%;"><strong>'.mo_("INVALID FORMAT MESSAGE").': </strong><br/>
								<span style="color:red">'.mo_("( NOTE: ##phone## in the message body will be replaced by the user's mobile number )").'</span></div>
								<textarea name="otp_invalid_phone" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($phone_invalid_format)).'</textarea><br/><br/>
								<div style="margin-bottom:1%;"><strong>'.mo_("BLOCKED PHONE MESSAGE").': </strong><br/>
								<span style="color:red">'.mo_("( NOTE: ##phone## in the message body will be replaced by the user's mobile number )").'</span></div>
								<textarea name="otp_blocked_phone" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($otp_blocked_phone)).'</textarea><br/>
							</div>
						</td>
					</tr>
				</table>
					...
					<tr>
						<td>
							...
							<div id="common_message" style="margin-left:1%">
								...
								<textarea name="invalid_otp" rows="4" style="width:100%;padding:2%;">'.mo_(esc_attr($invalid_otp)).'</textarea><br/>
							</div>
						</td>
					</tr>
				</table>
